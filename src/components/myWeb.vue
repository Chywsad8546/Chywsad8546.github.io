            ...
            <div class="carousel-inner animated">
                ...
                <blockquote>
                  <div class="row">
                    <div class="col-sm-3 text-center">
                      <img class="/static/img-circle" src="img/mike.png" alt="Mike Avatar">
                    </div>
                    <div class="col-sm-9">
              ...
              <div class="item">
                <blockquote>
                  <div class="row">
                    <div class="col-sm-3 text-center">
                      <img class="img-circle" src="/static/img/adam.jpg" alt="Adam Avatar">
                    </div>
                    <div class="col-sm-9">
              ...
              <div class="item">
                <blockquote>
                  <div class="row">
                    <div class="col-sm-3 text-center">
                      <img class="img-circle" src="/static/img/ben.png" alt="Ben Avatar">
                    </div>
                    <div class="col-sm-9">
